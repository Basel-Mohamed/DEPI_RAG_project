...
def build_multimodal_prompt_messages(
    *,
    ...
    """Build dictionary chat messages with image blocks attached."""
    ...
    return [
        {
            "role": str(messages[0].type),
            "content": str(messages[0].content),
        },
        {
            "role": str(messages[1].type),
            "content": [
                {
                    "type": "text",
...
def build_langchain_multimodal_messages(
    *,
    question: str,
    context: str,
    image_urls: list[str],
) -> list[Any]:
    """Build LangChain chat messages with image blocks attached."""
